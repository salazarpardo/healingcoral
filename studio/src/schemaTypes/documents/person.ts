...
export const person = defineType({
  ...
  fields: [
    ...
    defineField({
      ...
      title: 'Role / Title',
      type: 'string',
      description: 'e.g. Founding Partner, CTO, Creative Director',
    }),
    defineField({
      name: 'bio',
      title: 'Short bio',
      type: 'text',
      description: 'Brief description for the team section.',
    }),
    defineField({
      name: 'location',
      title: 'Location',
      type: 'string',
      description: 'e.g. COLOMBIA – for creator/artist profiles.',
    }),
    defineField({
      name: 'picture',
      title: 'Picture',

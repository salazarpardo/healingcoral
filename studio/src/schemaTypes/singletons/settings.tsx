...
export const settings = defineType({
  ...
  fields: [
    ...
    defineField({
      name: 'headerCta',
      title: 'Header CTA button (e.g. Get Involved)',
      type: 'button',
      group: 'header',
    }),
    defineField({
      ...
      of: [
        {
          ...
          preview: {
            ...
            prepare({name, media}) {
              return {title: name || 'Partner', media}
            },
          },
        },
      ],
    ...
    defineField({
      ...
      type: 'string',
      group: 'footer',
      initialValue: '© 2026 Healing Coral. All rights reserved.',
    }),
    defineField({
      name: 'description',
      description: 'Used for SEO and fallback',
      title: 'Description',
      type: 'array',
      group: 'seo',
